...
import 'theme.dart'; // Assuming theme.dart contains BuddyTheme
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> _pages = const [
    ...
    Center(child: Text('Need Room Page', style: TextStyle(fontSize: 24))),
    Center(child: Text('Need Flatmate Page', style: TextStyle(fontSize: 24))),
